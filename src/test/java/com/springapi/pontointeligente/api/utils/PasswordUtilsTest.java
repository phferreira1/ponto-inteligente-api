 ...
 * 
 * private static final String SENHA = "123456"; private final
 * BCryptPasswordEncoder bCrEncoder = new BCryptPasswordEncoder();
 * 
 * @Test public void testSenhaNula() throws Exception {
 * assertNull(PasswordUtils.gerarBCrypt(null)); }
 * 
 * 
 * public void testGerarHashSenha() throws Exception { String hash =
 * PasswordUtils.gerarBCrypt(SENHA);
 * 
